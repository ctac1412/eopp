...
Production legacy image:

```powershell
$env:EOPP_SOLO_FRONTEND_BASE_URL='https://45.12.75.110:8765'
...
- Production direct `:8765` bypasses nginx. Nginx proxies only `443 -> 8765`.
...
```powershell
curl.exe -k "https://45.12.75.110:8765/check-stream?api_key=<key>"
```
