...
function AuthWizard({ onAuthenticated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('')
    try {
      const resp = await fetch(`/validate-key?api_key=${encodeURIComponent(trimmed)}`)
  ...
  return (
    <div className="auth-wizard-overlay">
      <div className="auth-wizard-card">
        ...
        <div className="auth-wizard-subtitle">Введите API ключ киоска для начала работы</div>
