...
const areaSource = readFileSync(new URL("../components/operator/CaptchaArea.jsx", import.meta.url), "utf8");
const sidebarSource = readFileSync(new URL("../components/operator/OperatorSidebar.jsx", import.meta.url), "utf8");
