...
build-crx: typecheck-extension build-extension
	...
	@"C:\Users\BAZA\AppData\Local\Yandex\YandexBrowser\Application\browser.exe" --pack-extension="$(CURDIR)/extension/dist" --no-sandbox --pack-extension-key="$(CURDIR)/extension/my.pem"
